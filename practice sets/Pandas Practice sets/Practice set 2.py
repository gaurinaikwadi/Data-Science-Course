...
# 9. Given an "Email" column containing complete email addresses, how would you split the strings into two parts at the "@" symbol?
df['Email'].str.split('@')
...
# 12. Why is it recommended to use .copy() when assigning a filtered DataFrame to a new variable (e.g., df2 = df.dropna().copy() )?
